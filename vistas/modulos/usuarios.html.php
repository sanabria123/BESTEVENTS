       ...
       <div class="box-body">
        ...
        <table class="table table-bordered table-striped dt-responsive tablas">
          ...
          <tbody>
            ...
            <tr>
              <td>1</td>
              <td>Usuario Admistrador</td>
              <td>admin</td>
              <td><img src="vistas/img/usuarios/default/anonymous.jpg" class="img-thumbnail" width="40px"></td>
              <td>Administrador</td>
            ...
            <tr>
              ...
              <td>
                ...
                <div class="btn-group">
                  ...
                  <button class="btn btn-warning"><i class="fa fa-pencil"></1></button>
                  <button class="btn btn-danger"><i class="fa fa-times"></1></button>
